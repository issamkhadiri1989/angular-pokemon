export const POKEMON =  [
  ...
  export const TYPES = [
  { type: "electric", bg: "#f9e84a22", border: "#f9e84a", text: "#a07800" },
  { type: "water",    bg: "#6390f022", border: "#6390f0", text: "#1a3a9e" },
  { type: "grass",    bg: "#7ac74c22", border: "#7ac74c", text: "#2d6e10" },
  { type: "fire",     bg: "#ff424222", border: "#ff4242", text: "#8b0000" },
  { type: "psychic",  bg: "#a98ff322", border: "#a98ff3", text: "#4b2f9e" },
  { type: "poison",   bg: "#f95587",   border: "#c2275b", text: "#ffffff" },
  { type: "ice",      bg: "#96d9d622", border: "#96d9d6", text: "#1a6e6b" },
  { type: "dragon",   bg: "#c22e2822", border: "#c22e28", text: "#7a0c0a" },
  { type: "bug",      bg: "#a8b82022", border: "#a8b820", text: "#4a5200" },
  { type: "normal",   bg: "#b7b7ce22", border: "#b7b7ce", text: "#3d3d5c" },
  { type: "ground",   bg: "#73590022", border: "#b8860b", text: "#5c3a00" },
  { type: "flying",   bg: "#9dc1d322", border: "#9dc1d3", text: "#2a5a70" },
  { type: "rock",     bg: "#e2bf6522", border: "#e2bf65", text: "#7a5800" },
  { type: "ghost",    bg: "#5a547822", border: "#5a5478", text: "#1e1a3a" },
  { type: "fighting", bg: "#b6a136",   border: "#7a6500", text: "#ffffff" },
  { type: "dark",     bg: "#70526822", border: "#705268", text: "#3d1f3a" },
  { type: "fairy",    bg: "#d685ad22", border: "#d685ad", text: "#7a2a57" },
  { type: "steel",    bg: "#b7b7ce22", border: "#6c6c8c", text: "#3d3d5c" },
];